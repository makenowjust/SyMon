...
namespace boost {
  ...
  enum graph_clock_variable_size_t {
    graph_clock_variable_size
  };
  enum graph_string_variable_size_t {
    graph_string_variable_size
  };
  enum graph_number_variable_size_t {
    graph_number_variable_size
  };
  enum graph_parameter_size_t {
    graph_parameter_size
  };
...
static inline
std::ostream &operator<<(std::ostream &os, const TimingConstraint::Order &odr) {
  switch (odr) {
...
static inline
std::ostream &operator<<(std::ostream &os, const TimingConstraint &p) {
...
static inline
std::istream &operator>>(std::istream &is, TimingConstraint &p) {
  if (is.get() != 'x') {
...
template<typename TimingConstraint>
static inline
std::istream &operator>>(std::istream &is, Guard<TimingConstraint> &guard) {
  is >> guard.guard;
  return is;
}
...
template<typename TimingConstraint>
static inline
std::ostream &operator<<(std::ostream &os, const Guard<TimingConstraint> &guard) {
  os << guard.guard;
  return os;
}
...
boost::adjacency_list<
        ...
        BoostTAState, BoostTATransition<StringConstraint, NumberConstraint, TimingConstraint, Update>,
...
using NonParametricBoostTA = BoostTimedAutomaton<NonSymbolic::StringConstraint, NonSymbolic::NumberConstraint<Number>, TimingConstraint, NonSymbolic::Update>;
using DataParametricBoostTA = BoostTimedAutomaton<Symbolic::StringConstraint, Symbolic::NumberConstraint, TimingConstraint, Symbolic::Update>;
using BoostPTA = boost::adjacency_list<
        boost::listS, boost::vecS, boost::directedS,
        BoostTAState, BoostTATransition<Symbolic::StringConstraint, Symbolic::NumberConstraint, ParametricTimingConstraintHelper, Symbolic::Update>,
        boost::property<boost::graph_clock_variable_size_t, std::size_t,
                boost::property<boost::graph_string_variable_size_t, std::size_t,
...
template<typename StringConstraint, typename NumberConstraint, typename TimingConstraint, typename Update>
static inline
void parseBoostTA(std::istream &file,
                  BoostTimedAutomaton<StringConstraint, NumberConstraint, TimingConstraint, Update> &BoostTA) {

  boost::dynamic_properties dp(boost::ignore_other_properties);

  boost::ref_property_map<BoostTimedAutomaton<StringConstraint, NumberConstraint, TimingConstraint, Update> *, std::size_t> gcvar_size(
          get_property(BoostTA, boost::graph_clock_variable_size));
  dp.property("clock_variable_size", gcvar_size);
  boost::ref_property_map<BoostTimedAutomaton<StringConstraint, NumberConstraint, TimingConstraint, Update> *, std::size_t> gsvar_size(
          get_property(BoostTA, boost::graph_string_variable_size));
  dp.property("string_variable_size", gsvar_size);
  boost::ref_property_map<BoostTimedAutomaton<StringConstraint, NumberConstraint, TimingConstraint, Update> *, std::size_t> gnvar_size(
          get_property(BoostTA, boost::graph_number_variable_size));
  ...
  dp.property("reset",
              boost::get(&BoostTATransition<StringConstraint, NumberConstraint, TimingConstraint, Update>::resetVars,
                         BoostTA));
  dp.property("guard",
              boost::get(&BoostTATransition<StringConstraint, NumberConstraint, TimingConstraint, Update>::guard,
                         BoostTA));
  ...
  dp.property("s_update",
              boost::get(&BoostTATransition<StringConstraint, NumberConstraint, TimingConstraint, Update>::stringUpdate,
                         BoostTA));
  dp.property("n_constraints",
              boost::get(
                      &BoostTATransition<StringConstraint, NumberConstraint, TimingConstraint, Update>::numConstraints,
                      BoostTA));
  dp.property("s_constraints",
              boost::get(
                      &BoostTATransition<StringConstraint, NumberConstraint, TimingConstraint, Update>::stringConstraints,
                      BoostTA));
...
static inline
void parseBoostTA(std::istream &file, BoostPTA &BoostTA) {
  using namespace Symbolic;
  boost::dynamic_properties dp(boost::ignore_other_properties);

  boost::ref_property_map<BoostPTA *, std::size_t> gcvar_size(
          get_property(BoostTA, boost::graph_clock_variable_size));
  dp.property("clock_variable_size", gcvar_size);
  boost::ref_property_map<BoostPTA *, std::size_t> gsvar_size(
          get_property(BoostTA, boost::graph_string_variable_size));
  dp.property("string_variable_size", gsvar_size);
  boost::ref_property_map<BoostPTA *, std::size_t> gnvar_size(
          get_property(BoostTA, boost::graph_number_variable_size));
  dp.property("number_variable_size", gnvar_size);
  boost::ref_property_map<BoostPTA *, std::size_t> gparam_size(
          get_property(BoostTA, boost::graph_parameter_size));
  ...
  dp.property("n_update",
              boost::get(
                      &BoostTATransition<StringConstraint, NumberConstraint, ParametricTimingConstraintHelper, Update>::numberUpdate,
                      BoostTA));
  dp.property("s_update",
              boost::get(
                      &BoostTATransition<StringConstraint, NumberConstraint, ParametricTimingConstraintHelper, Update>::stringUpdate,
                      BoostTA));
  dp.property("n_constraints",
              boost::get(
                      &BoostTATransition<StringConstraint, NumberConstraint, ParametricTimingConstraintHelper, Update>::numConstraints,
                      BoostTA));
  dp.property("s_constraints",
              boost::get(
                      &BoostTATransition<StringConstraint, NumberConstraint, ParametricTimingConstraintHelper, Update>::stringConstraints,
                      BoostTA));
...
void convBoostTA(const BoostTimedAutomaton<StringConstraint, NumberConstraint, TimingConstraint, Update> &BoostTA,
  ...
  std::unordered_map<typename BoostTimedAutomaton<StringConstraint, NumberConstraint, TimingConstraint, Update>::vertex_descriptor, std::shared_ptr<AutomatonState<StringConstraint, NumberConstraint, std::vector<TimingConstraint>, Update>>> stateConvMap;
  for (auto first = vertex_range.first, last = vertex_range.second; first != last; ++first) {
    typename BoostTimedAutomaton<StringConstraint, NumberConstraint, TimingConstraint, Update>::vertex_descriptor v = *first;
    stateConvMap[v] = std::make_shared<AutomatonState<StringConstraint, NumberConstraint, std::vector<TimingConstraint>, Update>>(
  ...
  for (auto first = vertex_range.first, last = vertex_range.second; first != last; ++first) {
    ...
    for (auto firstEdge = edge_range.first, lastEdge = edge_range.second; firstEdge != lastEdge; ++firstEdge) {
      ...
      transition.guard = boost::get(
              &BoostTATransition<StringConstraint, NumberConstraint, TimingConstraint, Update>::guard, BoostTA,
              *firstEdge).guard;
      transition.resetVars = boost::get(
              &BoostTATransition<StringConstraint, NumberConstraint, TimingConstraint, Update>::resetVars,
              BoostTA, *firstEdge).resetVars;
      UpdateTraits<Update>::stringUpdate(transition.update) = boost::get(
              &BoostTATransition<StringConstraint, NumberConstraint, TimingConstraint, Update>::stringUpdate, BoostTA,
              *firstEdge);
      transition.stringConstraints = boost::get(
              &BoostTATransition<StringConstraint, NumberConstraint, TimingConstraint, Update>::stringConstraints,
              BoostTA, *firstEdge);
      UpdateTraits<Update>::numberUpdate(transition.update) = boost::get(
              &BoostTATransition<StringConstraint, NumberConstraint, TimingConstraint, Update>::numberUpdate, BoostTA,
              *firstEdge);
      transition.numConstraints = boost::get(
              &BoostTATransition<StringConstraint, NumberConstraint, TimingConstraint, Update>::numConstraints, BoostTA,
              *firstEdge);
      stateConvMap[*first]->next[boost::get(
              &BoostTATransition<StringConstraint, NumberConstraint, TimingConstraint, Update>::c, BoostTA,
              *firstEdge)].emplace_back(std::move(transition));
    }
  }
}
...
void convBoostTA(const BoostPTA &BoostTA, const Signature &signature, ParametricTA &TA, bool useDataDependentGuards) {
  ...
  TA.initialStates.clear();
  auto vertex_range = boost::vertices(BoostTA);
  std::unordered_map<typename BoostTimedAutomaton<StringConstraint, NumberConstraint, ParametricTimingConstraintHelper, Update>::vertex_descriptor, std::shared_ptr<AutomatonState<StringConstraint, NumberConstraint, ParametricTimingConstraint, Update>>> stateConvMap;
  for (auto first = vertex_range.first, last = vertex_range.second; first != last; ++first) {
    typename BoostTimedAutomaton<StringConstraint, NumberConstraint, ParametricTimingConstraintHelper, Update>::vertex_descriptor v = *first;
    stateConvMap[v] = std::make_shared<PTAState>(
            boost::get(&BoostTAState::isMatch, BoostTA, v));
    TA.states.emplace_back(stateConvMap[v]);
    if (boost::get(&BoostTAState::isInit, BoostTA, v)) {
      TA.initialStates.emplace_back(stateConvMap[v]);
